...
class ShippingFulfillmentApi
{
     ...
     * @return object
     */
    public function createShippingFulfillment($body, $order_id)
    {
        list($response) = $this->createShippingFulfillmentWithHttpInfo($body, $order_id);
        return $response;
    }
     ...
     */
    public function createShippingFulfillmentWithHttpInfo($body, $order_id)
    {
        $returnType = 'object';
        $request = $this->createShippingFulfillmentRequest($body, $order_id);
     ...
     */
    public function createShippingFulfillmentAsync($body, $order_id)
    {
        return $this->createShippingFulfillmentAsyncWithHttpInfo($body, $order_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createShippingFulfillmentAsyncWithHttpInfo($body, $order_id)
    {
        $returnType = 'object';
        $request = $this->createShippingFulfillmentRequest($body, $order_id);
     ...
     */
    protected function createShippingFulfillmentRequest($body, $order_id)
    {
