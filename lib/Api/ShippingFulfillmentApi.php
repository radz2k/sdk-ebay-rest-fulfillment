...
class ShippingFulfillmentApi
{
     ...
     *
     * @param  \Swagger\Client\Model\ShippingFulfillmentDetails $body fulfillment payload (required)
     ...
     * @return object
     */
    public function createShippingFulfillment($body, $content_type, $order_id)
    {
        list($response) = $this->createShippingFulfillmentWithHttpInfo($body, $content_type, $order_id);
        return $response;
    }
     ...
     */
    public function createShippingFulfillmentWithHttpInfo($body, $content_type, $order_id)
    {
        $returnType = 'object';
        $request = $this->createShippingFulfillmentRequest($body, $content_type, $order_id);
     ...
     */
    public function createShippingFulfillmentAsync($body, $content_type, $order_id)
    {
        return $this->createShippingFulfillmentAsyncWithHttpInfo($body, $content_type, $order_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createShippingFulfillmentAsyncWithHttpInfo($body, $content_type, $order_id)
    {
        $returnType = 'object';
        $request = $this->createShippingFulfillmentRequest($body, $content_type, $order_id);
     ...
     */
    protected function createShippingFulfillmentRequest($body, $content_type, $order_id)
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ShippingFulfillment
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ShippingFulfillment, HTTP status code, HTTP response headers (array of strings)
     */
    public function getShippingFulfillmentWithHttpInfo($fulfillment_id, $order_id)
    {
        $returnType = '\Swagger\Client\Model\ShippingFulfillment';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ShippingFulfillment',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ShippingFulfillmentPagedCollection
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ShippingFulfillmentPagedCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getShippingFulfillmentsWithHttpInfo($order_id)
    {
        $returnType = '\Swagger\Client\Model\ShippingFulfillmentPagedCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ShippingFulfillmentPagedCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
