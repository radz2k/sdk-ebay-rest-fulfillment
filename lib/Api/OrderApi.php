...
class OrderApi
{
     ...
     */
    public function issueRefund($order_id, $body = null)
    {
        list($response) = $this->issueRefundWithHttpInfo($order_id, $body);
        return $response;
    }
     ...
     */
    public function issueRefundWithHttpInfo($order_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\Refund';
        $request = $this->issueRefundRequest($order_id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function issueRefundAsync($order_id, $body = null)
    {
        return $this->issueRefundAsyncWithHttpInfo($order_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function issueRefundAsyncWithHttpInfo($order_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\Refund';
        $request = $this->issueRefundRequest($order_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function issueRefundRequest($order_id, $body = null)
    {
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
