...
class OrderApi
{
     ...
     */
    protected function getOrderRequest($order_id, $field_groups = null)
    {
        ...
        if ($field_groups !== null) {
            $queryParams['fieldGroups'] = ObjectSerializer::toQueryValue($field_groups, null);
        }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\OrderSearchPagedCollection
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\OrderSearchPagedCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrdersWithHttpInfo($field_groups = null, $filter = null, $limit = null, $offset = null, $order_ids = null)
    {
        $returnType = '\Swagger\Client\Model\OrderSearchPagedCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\OrderSearchPagedCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getOrdersRequest($field_groups = null, $filter = null, $limit = null, $offset = null, $order_ids = null)
    {
     ...
     * @param  \Swagger\Client\Model\IssueRefundRequest $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Refund
     */
    public function issueRefund($content_type, $order_id, $body = null)
    {
        list($response) = $this->issueRefundWithHttpInfo($content_type, $order_id, $body);
        return $response;
    }
     ...
     * @param  string $content_type This header indicates the format of the request body provided by the client. Its value should be set to &lt;b&gt;application/json&lt;/b&gt;. &lt;br&gt;&lt;br&gt; For more information, refer to &lt;a href&#x3D;\&quot;/api-docs/static/rest-request-components.html#HTTP\&quot; target&#x3D;\&quot;_blank \&quot;&gt;HTTP request headers&lt;/a&gt;. (required)
     * @param  string $order_id This path parameter is used to specify the unique identifier of the order associated with a refund.&lt;br&gt;&lt;br&gt;Use the &lt;a href&#x3D;\&quot;/api-docs/sell/fulfillment/resources/order/methods/getOrders\&quot; target&#x3D;\&quot;_blank \&quot;&gt;getOrders&lt;/a&gt; method to retrieve order IDs. (required)
     * @param  \Swagger\Client\Model\IssueRefundRequest $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\Refund, HTTP status code, HTTP response headers (array of strings)
     */
    public function issueRefundWithHttpInfo($content_type, $order_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\Refund';
        $request = $this->issueRefundRequest($content_type, $order_id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function issueRefundAsync($content_type, $order_id, $body = null)
    {
        return $this->issueRefundAsyncWithHttpInfo($content_type, $order_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function issueRefundAsyncWithHttpInfo($content_type, $order_id, $body = null)
    {
        $returnType = '\Swagger\Client\Model\Refund';
        $request = $this->issueRefundRequest($content_type, $order_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function issueRefundRequest($content_type, $order_id, $body = null)
    {
