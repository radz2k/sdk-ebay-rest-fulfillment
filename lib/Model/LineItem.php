...
class LineItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'applied_promotions' => '\Swagger\Client\Model\AppliedPromotion[]',
        'compatibility_properties' => '\Swagger\Client\Model\Property[]',
        'delivery_cost' => '\Swagger\Client\Model\DeliveryCost',
        'discounted_line_item_cost' => '\Swagger\Client\Model\Amount',
        'ebay_collect_and_remit_taxes' => '\Swagger\Client\Model\EbayCollectAndRemitTax[]',
        'ebay_collected_charges' => '\Swagger\Client\Model\EbayCollectedCharges',
        'gift_details' => '\Swagger\Client\Model\GiftDetails',
        'item_location' => '\Swagger\Client\Model\ItemLocation',
        'legacy_item_id' => 'string',
        'legacy_variation_id' => 'string',
        'line_item_cost' => '\Swagger\Client\Model\Amount',
        'line_item_fulfillment_instructions' => '\Swagger\Client\Model\LineItemFulfillmentInstructions',
        'line_item_fulfillment_status' => 'string',
        'line_item_id' => 'string',
        'linked_order_line_items' => '\Swagger\Client\Model\LinkedOrderLineItem[]',
        'listing_marketplace_id' => 'string',
        'properties' => '\Swagger\Client\Model\LineItemProperties',
        'purchase_marketplace_id' => 'string',
        'quantity' => 'int',
        'refunds' => '\Swagger\Client\Model\LineItemRefund[]',
        'sku' => 'string',
        'sold_format' => 'string',
        'taxes' => '\Swagger\Client\Model\Tax[]',
        'title' => 'string',
        'total' => '\Swagger\Client\Model\Amount',
        'variation_aspects' => '\Swagger\Client\Model\NameValuePair[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['ebay_collected_charges'] = isset($data['ebay_collected_charges']) ? $data['ebay_collected_charges'] : null;
        ...
        $this->container['linked_order_line_items'] = isset($data['linked_order_line_items']) ? $data['linked_order_line_items'] : null;
     ...
     *
     * @return \Swagger\Client\Model\AppliedPromotion[]
     */
     ...
     *
     * @param \Swagger\Client\Model\AppliedPromotion[] $applied_promotions This array contains information about one or more sales promotions or discounts applied to the line item. It is always returned, but will be returned as an empty array if no special sales promotions or discounts apply to the order line item.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Property[] $compatibility_properties This array is only returned for a Parts & Accessory item, and identifies the buyer's motor vehicle that is compatible with the part or accessory.
     *
     * @return $this
     */
     ...
     * Gets delivery_cost
     *
     * @return \Swagger\Client\Model\DeliveryCost
     */
     ...
     * Sets delivery_cost
     *
     * @param \Swagger\Client\Model\DeliveryCost $delivery_cost delivery_cost
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Amount $discounted_line_item_cost discounted_line_item_cost
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\EbayCollectAndRemitTax[]
     */
     ...
     *
     * @return \Swagger\Client\Model\EbayCollectedCharges
     */
     ...
     *
     * @param \Swagger\Client\Model\EbayCollectedCharges $ebay_collected_charges ebay_collected_charges
     *
     * @return $this
     */
     ...
     * Sets gift_details
     *
     * @param \Swagger\Client\Model\GiftDetails $gift_details gift_details
     *
     * @return $this
     */
     ...
     * Gets item_location
     *
     * @return \Swagger\Client\Model\ItemLocation
     */
     ...
     * Sets item_location
     *
     * @param \Swagger\Client\Model\ItemLocation $item_location item_location
     *
     * @return $this
     */
     ...
     * Sets legacy_item_id
     *
     * @param string $legacy_item_id The eBay-generated legacy listing item ID of the listing. Note that the unique identifier of a listing in REST-based APIs is called the <strong>listingId</strong> instead.
     *
     * @return $this
     */
     ...
     * Sets line_item_cost
     *
     * @param \Swagger\Client\Model\Amount $line_item_cost line_item_cost
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\LineItemFulfillmentInstructions
     */
     ...
     *
     * @param \Swagger\Client\Model\LineItemFulfillmentInstructions $line_item_fulfillment_instructions line_item_fulfillment_instructions
     *
     * @return $this
     */
     ...
     *
     * @param string $line_item_fulfillment_status This enumeration value indicates the current fulfillment status of the line item. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/fulfillment/types/sel:LineItemFulfillmentStatusEnum'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets line_item_id
     *
     * @param string $line_item_id This is the unique identifier of an eBay order line item. This field is created as soon as there is a commitment to buy from the seller.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\LinkedOrderLineItem[]
     */
     ...
     *
     * @param string $listing_marketplace_id The unique identifier of the eBay marketplace where the line item was listed. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/fulfillment/types/ba:MarketplaceIdEnum'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Gets properties
     *
     * @return \Swagger\Client\Model\LineItemProperties
     */
     ...
     * Sets properties
     *
     * @param \Swagger\Client\Model\LineItemProperties $properties properties
     *
     * @return $this
     */
     ...
     * Gets refunds
     *
     * @return \Swagger\Client\Model\LineItemRefund[]
     */
     ...
     * Sets refunds
     *
     * @param \Swagger\Client\Model\LineItemRefund[] $refunds This array is always returned, but is returned as an empty array unless the seller has submitted a partial or full refund to the buyer for the order. If a refund has occurred, the refund amount and refund date will be shown for each refund.
     *
     * @return $this
     */
     ...
     * Sets sold_format
     *
     * @param string $sold_format The eBay listing type of the line item. The most common listing types are <code>AUCTION</code> and <code>FIXED_PRICE</code>. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/fulfillment/types/sel:SoldFormatEnum'>eBay API documentation</a>
     *
     * @return $this
     */
     ...
     * Sets taxes
     *
     * @param \Swagger\Client\Model\Tax[] $taxes Contains a list of taxes applied to the line item, if any. This array is always returned, but will be returned as empty if no taxes are applicable to the line item.
     *
     * @return $this
     */
     ...
     * Sets title
     *
     * @param string $title The title of the listing.<br><br><span class=\"tablenote\"><b>Note:</b> The Item ID value for the listing will be returned in this field instead of the actual title if this particular listing is on-hold due to an eBay policy violation.</span>
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\NameValuePair[] $variation_aspects An array of aspect name-value pairs that identifies the specific variation of a multi-variation listing. This array can contain multiple name-value pairs, such as <code>color:blue</code> and <code>size:large</code>, and will only be returned for orders created from a multiple-variation listing.
     *
     * @return $this
     */
