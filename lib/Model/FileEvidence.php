...
class FileEvidence implements ModelInterface, ArrayAccess
{
     ...
     * Sets file_id
     *
     * @param string $file_id This field is used to identify the evidence file to be uploaded to the evidence set.<br><br> This file is created with the <a href=\"/api-docs/sell/fulfillment/resources/payment_dispute/methods/uploadEvidenceFile\" target=\"_blank \">uploadEvidenceFile</a> method and can be retrieved using the <a href=\"/api-docs/sell/fulfillment/resources/payment_dispute/methods/getPaymentDisputes\" target=\"_blank \">getPaymentDisputes</a> method.
     *
     * @return $this
     */
