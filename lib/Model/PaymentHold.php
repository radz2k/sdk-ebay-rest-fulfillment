...
class PaymentHold implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'hold_amount' => '\Swagger\Client\Model\Amount',
        'hold_reason' => 'string',
        'hold_state' => 'string',
        'release_date' => 'string',
        'seller_actions_to_release' => '\Swagger\Client\Model\SellerActionsToRelease[]'
    ];
     ...
     * Sets hold_amount
     *
     * @param \Swagger\Client\Model\Amount $hold_amount hold_amount
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\SellerActionsToRelease[]
     */
     ...
     *
     * @param \Swagger\Client\Model\SellerActionsToRelease[] $seller_actions_to_release A list of one or more possible actions that the seller can take to expedite the release of the payment hold.
     *
     * @return $this
     */
