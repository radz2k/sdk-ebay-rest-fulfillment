...
class Error implements ModelInterface, ArrayAccess
{
     ...
     * Sets long_message
     *
     * @param string $long_message An expanded version of the <b>message</b> field. <br><br><b>Maximum length:</b> 200 characters
     *
     * @return $this
     */
     ...
     * Sets parameters
     *
     * @param \Swagger\Client\Model\ErrorParameter[] $parameters Contains a list of name-value pairs that provide additional information concerning this error or warning. Each item in the list is an input parameter that contributed to the error or warning condition.
     *
     * @return $this
     */
