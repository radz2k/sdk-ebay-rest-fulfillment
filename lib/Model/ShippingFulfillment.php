...
class ShippingFulfillment implements ModelInterface, ArrayAccess
{
     ...
     * Sets fulfillment_id
     *
     * @param string $fulfillment_id The unique identifier of the fulfillment; for example, <code>9405509699937003457459</code>. This eBay-generated value is created with a successful <b>createShippingFulfillment</b> call.
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \Swagger\Client\Model\LineItemReference[] $line_items This array contains a list of one or more line items (and purchased quantity) to which the fulfillment applies.
     *
     * @return $this
     */
