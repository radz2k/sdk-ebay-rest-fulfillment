...
class OrderSearchPagedCollection implements ModelInterface, ArrayAccess
{
     ...
     * Sets href
     *
     * @param string $href The URI of the <b>getOrders</b> call request that produced the current page of the result set.
     *
     * @return $this
     */
     ...
     * Sets offset
     *
     * @param int $offset The number of results skipped in the result set before listing the first returned result. This value can be set in the request with the <b>offset</b> query parameter. <p class=\"tablenote\"><strong>Note: </strong>The items in a paginated result set use a zero-based list where the first item in the list has an offset of <code>0</code>.</p>
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param int $total The total number of orders in the results set based on the current input criteria.<br><br><span class=\"tablenote\"><strong>Note:</strong> If no orders are found, this field is returned with a value of <code>0</code>.</span>
     *
     * @return $this
     */
     ...
     * Sets warnings
     *
     * @param \Swagger\Client\Model\Error[] $warnings This array is returned if one or more errors or warnings occur with the call request.
     *
     * @return $this
     */
