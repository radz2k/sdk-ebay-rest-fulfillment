...
class CancelRequest implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $cancel_request_state The current stage or condition of the cancellation request. This field is returned for each cancellation request. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/fulfillment/types/sel:CancelRequestStateEnum'>eBay API documentation</a>
     *
     * @return $this
     */
