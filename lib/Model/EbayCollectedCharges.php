...
class EbayCollectedCharges implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'ebay_shipping' => '\Swagger\Client\Model\Amount',
        'charges' => '\Swagger\Client\Model\Charge[]'
    ];
     ...
     * Sets ebay_shipping
     *
     * @param \Swagger\Client\Model\Amount $ebay_shipping ebay_shipping
     *
     * @return $this
     */
     ...
     * Sets charges
     *
     * @param \Swagger\Client\Model\Charge[] $charges This array shows any charges that eBay collects from the buyer.<br><br><span class=\"tablenote\"><strong> Note: </strong> Currently, the only supported charge type is BUYER_PROTECTION.</span>
     *
     * @return $this
     */
