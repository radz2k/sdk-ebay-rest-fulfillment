...
class CancelStatus implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'cancel_requests' => '\Swagger\Client\Model\CancelRequest[]',
        'cancel_state' => 'string'
    ];
     ...
     * Sets cancelled_date
     *
     * @param string $cancelled_date The date and time the order was cancelled, if applicable. This timestamp is in ISO 8601 format, which uses the 24-hour Universal Coordinated Time (UTC) clock. <br><br><b>Format:</b> <code>[YYYY]-[MM]-[DD]T[hh]:[mm]:[ss].[sss]Z</code> <br><b>Example:</b> <code>2015-08-04T19:09:02.768Z</code>
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\CancelRequest[]
     */
     ...
     * Sets cancel_state
     *
     * @param string $cancel_state The state of the order with regard to cancellation. This field is always returned, and if there are no cancellation requests, a value of <code>NONE_REQUESTED</code> is returned.  For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/fulfillment/types/sel:CancelStateEnum'>eBay API documentation</a>
     *
     * @return $this
     */
