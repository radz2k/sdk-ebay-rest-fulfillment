...
class IssueRefundRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets refund_items
     *
     * @param \Swagger\Client\Model\RefundItem[] $refund_items The <b>refundItems</b> array is only required if the seller is issuing a refund for one or more individual order line items in a multiple line item order. Otherwise, the seller just uses the <b>orderLevelRefundAmount</b> container to specify the amount of the refund for the entire order.
     *
     * @return $this
     */
