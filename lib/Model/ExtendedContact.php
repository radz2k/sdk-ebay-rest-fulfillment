...
class ExtendedContact implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'company_name' => 'string',
        'contact_address' => '\Swagger\Client\Model\Address',
        'email' => 'string',
        'full_name' => 'string',
        'primary_phone' => '\Swagger\Client\Model\PhoneNumber'
    ];
     ...
     *
     * @param \Swagger\Client\Model\Address $contact_address contact_address
     *
     * @return $this
     */
     ...
     * Sets full_name
     *
     * @param string $full_name The full name of the buyer or eBay shipping partner.<br><br><span class=\"tablenote\"><strong>Note:</strong> The <b>fullName</b> will not be returned for any order that is more than 90 days old.</span>
     *
     * @return $this
     */
     ...
     * Sets primary_phone
     *
     * @param \Swagger\Client\Model\PhoneNumber $primary_phone primary_phone
     *
     * @return $this
     */
