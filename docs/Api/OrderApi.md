...
# **getOrder**
> \Swagger\Client\Model\Order getOrder($order_id, $field_groups)
...
# **getOrders**
> \Swagger\Client\Model\OrderSearchPagedCollection getOrders($field_groups, $filter, $limit, $offset, $order_ids)
...
[**\Swagger\Client\Model\OrderSearchPagedCollection**](../Model/OrderSearchPagedCollection.md)
...
# **issueRefund**
> \Swagger\Client\Model\Refund issueRefund($content_type, $order_id, $body)
 ...
 **body** | [**\Swagger\Client\Model\IssueRefundRequest**](../Model/IssueRefundRequest.md)|  | [optional]
